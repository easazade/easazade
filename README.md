...
- ✌ Right now I'm creating [crystalline](https://github.com/easazade/crystalline), a universal state definition package for all flutter state management packages, Riverpod, Bloc, Mobx and so forth, that gives you the power of creating crystal-clear state objects.
